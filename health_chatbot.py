...
os.environ['GROQ_API_KEY'] = "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"
...
def diagnose(symptoms):
    ...
    if symptom_lower in training_data:
        ...
        messages = [SystemMessage("You are a virtual doctor that you predict the diesease name and give the medication , medical assesments and remedies ."), HumanMessage(f"I have {symptoms}. What should I do?")]
...
def main():
    ...
    if not st.session_state.authenticated:
        ...
        if st.button("Login"):
            if username == "Prajen SK" and password == "Prajenram@2004":
